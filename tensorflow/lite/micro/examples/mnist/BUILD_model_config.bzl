...
def get_model_info(prefix = MODEL_PREFIX):
    return {
        "srcs": [
            "//tensorflow/lite/micro/examples/mnist/models:generated_%s_float_model_cc" % prefix,
            "//tensorflow/lite/micro/examples/mnist/models:generated_%s_int8_model_cc" % prefix,
        ],
        "hdrs": [
            "//tensorflow/lite/micro/examples/mnist/models:generated_%s_float_model_hdr" % prefix,
            "//tensorflow/lite/micro/examples/mnist/models:generated_%s_int8_model_hdr" % prefix,
        ],
        "tflite_files": [
            "//tensorflow/lite/micro/examples/mnist/models:%s_float.tflite" % prefix,
            "//tensorflow/lite/micro/examples/mnist/models:%s_int8.tflite" % prefix,
        ],
        # "test_file": "mnist_test_%s.cc" % prefix,
